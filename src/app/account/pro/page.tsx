        ...
        {isPro && subscription ? (
          <div className="mt-6">
            ...
            <button
              ...
              disabled={cancelling}
              className="mt-6 rounded-xl border border-red-200 px-5 py-3 font-semibold text-red-600 disabled:opacity-50"
            >
