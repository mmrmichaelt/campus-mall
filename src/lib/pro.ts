...
const PRICING_BY_CURRENCY: Record<string, Omit<ProPricing, "currency">> = {
  ...
  BIF: { monthly: 6000, yearly: 60000, symbol: "FBu", locale: "fr-BI" },
  CDF: { monthly: 7000, yearly: 70000, symbol: "FC", locale: "fr-CD" },
  SOS: { monthly: 18000, yearly: 180000, symbol: "S", locale: "so-SO" },
  SSP: { monthly: 3000, yearly: 30000, symbol: "SS£", locale: "en-SS" },
...
const COUNTRY_CURRENCY: Record<string, string> = {
  ...
  BT:"BTN",BN:"BND",FJ:"FJD",PG:"PGK",WS:"WST",TO:"TOP",VU:"VUV",
};
